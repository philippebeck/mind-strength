<template>
  <!-- ! AUDIO -->
  <figure v-if="type === 'audio'" :itemprop="itemprop" itemscope itemtype="https://schema.org/AudioObject">
  ...
  <!-- ! VIDEO -->
  <figure v-else-if="type === 'video'" :itemprop="itemprop" itemscope itemtype="https://schema.org/VideoObject">
  ...
  <!-- ! QUOTE -->
  <figure v-else-if="type === 'quote'" :itemprop="itemprop" itemscope itemtype="https://schema.org/Quotation">
  ...
  <!-- ! PICTURE -->
  <figure v-else-if="type === 'picture'" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
    <picture>
      <source
  ...
  <!-- ! IMG -->
  <figure v-else itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
